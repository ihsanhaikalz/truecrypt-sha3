...
namespace TrueCrypt
{
	...
	class Sha3 : public Hash
		...
		public:
			...
			virtual void GetDigest (const BufferPtr &buffer);
			virtual size_t GetBlockSize () const { return 136; }
			virtual size_t GetDigestSize () const { return 256 / 8; }
			virtual wstring GetName () const { return L"Sha3"; }
			virtual shared_ptr <Hash> GetNew () const { return shared_ptr <Hash> (new Sha3); }
			virtual void Init ();
			virtual void ProcessData (const ConstBufferPtr &data);
